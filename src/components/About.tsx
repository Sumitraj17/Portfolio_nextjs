...
const About = () => {
  return (
    <div id="about" className="max-w-[1200px] mx-auto text-white/70">
        ...
        <div className="w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border-white/20 rounded-xl overflow-hidden">
          ...
          <div className="flex flex-row p-6">
            ...
            <div className="flex flex-col mt-4">
              ...
              <p className="text-lg text-white/70 mt-2">
                As a Fullstack Web Developer, I have agood knowledge of ReactJs,
                Angular, and Tailwind CSS. My expertise extends to creating
